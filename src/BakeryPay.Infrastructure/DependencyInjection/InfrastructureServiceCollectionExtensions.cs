...
using BakeryPay.Application.Services;
using BakeryPay.Infrastructure.Email;
using BakeryPay.Infrastructure.Persistence;
using BakeryPay.Infrastructure.Repositories;
using BakeryPay.Infrastructure.Security;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

namespace BakeryPay.Infrastructure.DependencyInjection;
